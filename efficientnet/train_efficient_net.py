...
from efficient_net_classifier import EfficientNetB0Transfer
...
def main():
    ...
    RESULTS_DIR = f'{PROJECT_DIR}/results/efficientnetb0'
    ...
    CHECKPOINT_PATH = f'{CHECKPOINT_DIR}/efficientnetb0_best.h5'
    MODEL_SAVE_PATH = f'{MODEL_DIR}/efficientnetb0_final.h5'
    
    print("="*70)
    print("PNEUMONIA DETECTION - EFFICIENTNETB0 TRAINING PIPELINE")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("STEP 4: BUILDING EFFICIENTNETB0 MODEL")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("STEP 5: TRAINING EFFICIENTNETB0 MODEL")
    print("="*70)
    ...
    try:
        ...
        model.save_model(filepath=f'{MODEL_DIR}/efficientnetb0_interrupted.h5')
        ...
        print("Saving current model state...")
        model.save_model(filepath=f'{MODEL_DIR}/efficientnetb0_error.h5')
        raise
    
    print("\nGenerating training history plots...")
    model.plot_training_history(save_path=f'{RESULTS_DIR}/efficientnetb0_training_history.png')
    ...
    print("\n" + "="*70)
    print("FINAL TEST METRICS - EFFICIENTNETB0")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("TRAINING SUMMARY - EFFICIENTNETB0")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("🎉 EFFICIENTNETB0 TRAINING PIPELINE COMPLETE! 🎉")
    print("="*70)
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("STARTING EFFICIENTNETB0 TRAINING PIPELINE")
    print("="*70)
