...
from res_net_classifier import ResNet50Transfer
...
def main():
    ...
    RESULTS_DIR = f'{PROJECT_DIR}/results/resnet50'
    ...
    CHECKPOINT_PATH = f'{CHECKPOINT_DIR}/resnet50_best.h5'
    MODEL_SAVE_PATH = f'{MODEL_DIR}/resnet50_final.h5'
    
    print("="*70)
    print("PNEUMONIA DETECTION - RESNET50 TRAINING PIPELINE")
    print("="*70)
    ...
    try:
        ...
        model.save_model(filepath=f'{MODEL_DIR}/resnet50_interrupted.h5')
        ...
        print("Saving current model state...")
        model.save_model(filepath=f'{MODEL_DIR}/resnet50_error.h5')
        raise
    
    print("\nGenerating training history plots...")
    model.plot_training_history(save_path=f'{RESULTS_DIR}/resnet50_training_history.png')
    ...
    print("\n" + "="*70)
    print("FINAL TEST METRICS - RESNET50")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("RESNET50 TRAINING PIPELINE COMPLETE!")
    print("="*70)
...
if __name__ == "__main__":
    ...
    print("\n" + "="*70)
    print("STARTING RESNET50 TRAINING PIPELINE")
    print("="*70)
